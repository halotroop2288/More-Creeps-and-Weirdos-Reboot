...
public class ClientProxy extends CommonProxy
{
	public void render()
	{
		...
		RenderingRegistry.registerEntityRenderingHandler(SnowDevilEntity.class,
				new CREEPSRenderSnowDevil(new CREEPSModelSnowDevil(), new CREEPSModelSnowDevil(0.5F), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(SquimpEntity.class,
				new CREEPSRenderSquimp(new CREEPSModelSquimp(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(ThiefEntity.class,
				new CREEPSRenderThief(new ModelBiped(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(TombstoneEntity.class,
				new CREEPSRenderTombstone(new CREEPSModelTombstone(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(TowelEntity.class,
				new CREEPSRenderTowel(new CREEPSModelTowel(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(TrophyEntity.class,
				new CREEPSRenderTrophy(new CREEPSModelTrophy(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(ZebraEntity.class,
				new CREEPSRenderZebra(new CREEPSModelZebra(), 0.5F));
	}

	public void renderModelItem() {
		Minecraft.getInstance().getRenderManager().getItemModelMesher().register(MoreCreepsReboot.partBubble, 0,
				new ModelResourceLocation("morecreeps:partBubble", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.partWhite, 0, new ModelResourceLocation("morecreeps:partWhite", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.partRed, 0, new ModelResourceLocation("morecreeps:partRed", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.partBlack, 0, new ModelResourceLocation("morecreeps:partBlack", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.partYellow, 0, new ModelResourceLocation("morecreeps:partYellow", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.partBlue, 0, new ModelResourceLocation("morecreeps:partBlue", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.partShrink, 0, new ModelResourceLocation("morecreeps:partShrink", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.partBarf, 0, new ModelResourceLocation("morecreeps:partBarf", "inventory"));

		
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_hell, 0, new ModelResourceLocation("morecreeps:a_hell", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_pig, 0, new ModelResourceLocation("morecreeps:a_pig", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_pyramid, 0, new ModelResourceLocation("morecreeps:a_pyramid", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_floob, 0, new ModelResourceLocation("morecreeps:a_floob", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_rockmonster, 0, new ModelResourceLocation("morecreeps:a_rockmonster", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_bubble, 0, new ModelResourceLocation("morecreeps:a_bubble", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_hotdog, 0, new ModelResourceLocation("morecreeps:a_hotdog", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_camel, 0, new ModelResourceLocation("morecreeps:a_camel", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_zebra, 0, new ModelResourceLocation("morecreeps:a_zebra", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_nonswimmer, 0, new ModelResourceLocation("morecreeps:a_nonswimmer", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.a_caveman, 0, new ModelResourceLocation("morecreeps:a_caveman", "inventory"));
		
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.zebrahelmet, 0, new ModelResourceLocation("morecreeps:zebraHelmet", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.zebrabody, 0, new ModelResourceLocation("morecreeps:zebraBody", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.zebralegs, 0, new ModelResourceLocation("morecreeps:zebraLegs", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.zebraboots, 0, new ModelResourceLocation("morecreeps:zebraBoots", "inventory"));
		
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.blorpcola, 0, new ModelResourceLocation("morecreeps:blorpCola", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.bandaid, 0, new ModelResourceLocation("morecreeps:bandAid", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.goodonut, 0, new ModelResourceLocation("morecreeps:gooDonut", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.money, 0, new ModelResourceLocation("morecreeps:money", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.raygun, 0, new ModelResourceLocation("morecreeps:raygun", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.shrinkray, 0, new ModelResourceLocation("morecreeps:shrinkray", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.shrinkshrink, 0, new ModelResourceLocation("morecreeps:shrinkshrink", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.limbs, 0, new ModelResourceLocation("morecreeps:limbs", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.babyjarempty, 0, new ModelResourceLocation("morecreeps:babyJarEmpty", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.babyjarfull, 0, new ModelResourceLocation("morecreeps:babyJarFull", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.mobilephone, 0, new ModelResourceLocation("morecreeps:mobilephone", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.growray, 0, new ModelResourceLocation("morecreeps:growray", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.frisbee, 0, new ModelResourceLocation("morecreeps:frisbee", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.rayray, 0, new ModelResourceLocation("morecreeps:rayray", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.guineapigradio, 0, new ModelResourceLocation("morecreeps:guineapigRadio", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.evilegg, 0, new ModelResourceLocation("morecreeps:evilEgg", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.rocket, 0, new ModelResourceLocation("morecreeps:rocket", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.atompacket, 0, new ModelResourceLocation("morecreeps:atomPacket", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.ram16k, 0, new ModelResourceLocation("morecreeps:ram16k", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.battery, 0, new ModelResourceLocation("morecreeps:battery", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.horseheadgem, 0, new ModelResourceLocation("morecreeps:horseHeadGem", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.armygem, 0, new ModelResourceLocation("morecreeps:armyGem", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.gun, 0, new ModelResourceLocation("morecreeps:gun", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.bullet, 0, new ModelResourceLocation("morecreeps:bullet", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.lifegem, 0, new ModelResourceLocation("morecreeps:lifeGem", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.lolly, 0, new ModelResourceLocation("morecreeps:lolly", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.armsword, 0, new ModelResourceLocation("morecreeps:armSword", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.donut, 0, new ModelResourceLocation("morecreeps:donut", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.extinguisher, 0, new ModelResourceLocation("morecreeps:extinguisher", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.zebrahide, 0, new ModelResourceLocation("morecreeps:zebrahide", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.firegem, 0, new ModelResourceLocation("morecreeps:fireGem", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.earthgem, 0, new ModelResourceLocation("morecreeps:earthGem", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.mininggem, 0, new ModelResourceLocation("morecreeps:miningGem", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.healinggem, 0, new ModelResourceLocation("morecreeps:healingGem", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.skygem, 0, new ModelResourceLocation("morecreeps:skyGem", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.gemsword, 0, new ModelResourceLocation("morecreeps:gemSword", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.moopsworm, 0, new ModelResourceLocation("morecreeps:moopsWorm", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.cavemanclub, 0, new ModelResourceLocation("morecreeps:cavemanClub", "inventory"));
		Minecraft.getInstance().getRenderItem().getItemModelMesher().register(MoreCreepsReboot.popsicle, 0, new ModelResourceLocation("morecreeps:popsicle", "inventory"));
	}
	...
	public void rocketSmoke(World world, Entity entity, Item item)
	{
        ...
        Minecraft.getInstance().effectRenderer.addEffect(creepsfxsmoke1);
        ...
        Minecraft.getInstance().effectRenderer.addEffect(creepsfxsmoke2);
	}
		...
		if(world.isRemote)
		{
	        for (int i = 1; i < 10; i++)
	        {
	            for (int j = 0; j < 10; j++)
	            {
	                ...
	                Minecraft.getInstance().effectRenderer.addEffect(creepsfxconfetti);
	            }
	        }
		}
	}
	...
	public void foam2(World world, AtomEntity atom)
	{
        for (int i1 = 0; (float)i1 < atom.atomsize; i1++)
        {
            ...
            Minecraft.getInstance().effectRenderer.addEffect(creepsfxatoms);
        }
	}
