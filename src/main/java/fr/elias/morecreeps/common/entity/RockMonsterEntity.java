...
public class RockMonsterEntity extends EntityMob
{
    ...
    public boolean getCanSpawnHere(World world)
    {
        ...
        return i1 != Blocks.cobblestone && i1 != Blocks.log && i1 != Blocks.double_stone_slab && i1 != Blocks.stone_slab && i1 != Blocks.planks && i1 != Blocks.wool && world.getCollidingBoundingBoxes(this, getEntityBoundingBox()).size() == 0 && world.canSeeSky(new BlockPos(i, j, k)) && rand.nextInt(15) == 0 && l > 8;
    }
    /**
    ...
    public void playLivingSound(World world)
    {
        ...
        if (s != null)
        {
            world.playSound(this, s, getSoundVolume(), (rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F + (3F - modelsize));
        }
    }
    ...
    public void onDeath(DamageSource damagesource)
    {
        ...
        if (entity != null && (entity instanceof EntityPlayer) && !((EntityPlayerMP)entity).getStatFile().hasAchievementUnlocked(MoreCreepsReboot.achieverockmonster))
        {
            world.playSoundAtEntity(entity, "morecreeps:achievement", 1.0F, 1.0F);
            ((EntityPlayer) entity).addStat(MoreCreepsReboot.achieverockmonster, 1);
        }
