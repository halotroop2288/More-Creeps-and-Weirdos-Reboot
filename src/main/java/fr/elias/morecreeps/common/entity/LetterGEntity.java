...
public class LetterGEntity extends EntityMob
{
    ...
    class AIAttackEntity extends EntityAIBase
    {
		...
		{
			float f = LetterGEntity.this.getDistanceToEntity(getAttackTarget());
			if(f < 256F)
			{
				attackEntity(LetterGEntity.this.getAttackTarget(), f);
				LetterGEntity.this.getLookHelper().setLookPositionWithEntity(LetterGEntity.this.getAttackTarget(), 10.0F, 10.0F);
				LetterGEntity.this.getNavigator().clearPathEntity();
    ...
    public boolean getCanSpawnHere(World world)
    {
        ...
        return i1 != Blocks.sand && i1 != Blocks.cobblestone && i1 != Blocks.log && i1 != Blocks.double_stone_slab && i1 != Blocks.stone_slab && i1 != Blocks.planks && i1 != Blocks.wool && world.getCollidingBoundingBoxes(this, getEntityBoundingBox()).size() == 0 && rand.nextInt(15) == 0 && j1 < 5;
    }
    ...
    public void playLivingSound(World world)
    {
        ...
        if (s != null)
        {
            world.playSoundAtEntity(this, s, getSoundVolume(), (rand.nextFloat() - rand.nextFloat()) * 0.2F + 1.0F + (2.0F - modelsize) * 2.0F);
        }
    }
    ...
    public void onDeath(DamageSource damagesource, World world)
    {
    	if(!world.isRemote)
    	{
            ...
            {
                dropItem(MoreCreepsReboot.goodonut, rand.nextInt(3) + 1);
            }
